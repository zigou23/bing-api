...
async function handleRequest(request: Request) {
  ...
  try {
    ...
    if (path == "/" ||hostdomain != 'bingimg.deno.dev' && hostdomain != 'bingapi.qsim.top' || !ua.match(/Mozilla\/5.0\b/i) ) {
      return new Response('/img|/jsonall|/json|?day=[0-14]&random=1&server=1&mkt=en-US&hd=1&s=1920x1080', headers_init); //暂时不开放
    }
    ...
    //url link all day 15
    const Url1 = "https://bing.com/HPImageArchive.aspx?format=js&idx=0&n=8&mkt="+BingImglanguage;
    const Url2 = "https://bing.com/HPImageArchive.aspx?format=js&idx=7&n=8&mkt="+BingImglanguage;
